...

{
    ...
    $model->thumbnail( $source_image, $temp_file->filename, 200 );
...

{
    ...
    $model->thumbnail( $source_image, $temp_file->filename, 160 );
...

{
    ...
    $model->thumbnail( $source_image, $temp_file->filename, 600 );
...

{
    ...
    throws_ok{
        $model->thumbnail( $source_image, $temp_file->filename, 123 );
...

{
    ...
    $model->create_blank( $temp_file->filename );
