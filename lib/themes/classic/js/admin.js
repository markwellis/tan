...
// why is there no comments?
                        if (json_data != null){
                            ...
                            if ( kind === 'user' ){
                                formdata += '<label for="delete_comments">delete comments? :/</label>'
                                    +'<input type="checkbox" id="delete_comments" name="delete_comments" value="1" /><br />'
                                    +'<label for="delete_objects">delete links/blogs/pics? :/</label>'
                                    +'<input type="checkbox" id="delete_objects" name="delete_objects" value="1" /><br />';
                            }
